...
## Installation
### Requirements
* Raspberry Pi Model 3 - Haven't tested on older models but you're welcome to try!
...
* Node installed - I used 11.1.0, but you should be able to use any version that supports ES6 features.
* Something to let you SSH into the Raspberry Pi if you like.
...
For example, the Pi terminal will read something like: `Server listening on http://10.0.0.8:3000` and you just copy and paste the url or manually look for it's address yourself and type it in.
